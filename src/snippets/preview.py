...
class Preview:
    def __init__(self, config, proxies_amount):
        ...
        input(f"""  GMAIL MAKER WITH OTP BOT

[{self.colors.MAGENTA}#{self.colors.RESET}] Made with love Setiawan007 & Genlify Team

[{self.colors.MAGENTA}#{self.colors.RESET}] https://github.com/Setiawan007/Gmail-Maker-BOT

[{self.colors.MAGENTA}#{self.colors.RESET}] Special Thanks to All Contributors
